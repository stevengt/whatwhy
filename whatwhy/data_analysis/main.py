...
def main():
    ...
    arggroup.add_argument( "--train",
                           action="store_true",
                           help=( "Trains a prediction model using a supplied CSV file or previously loaded \n"
                                  "data set. This will overwrite any previously trained models."
                                )
                         )

    arggroup.add_argument( "--predict",
                           nargs="+",
                           default=None,
                           help=( "Uses a previously trained model to predict a sequence of 'why' text \n"
                                  "from the input 'what' text."
                                )
                         )

    arggroup.add_argument( "--compare-test",
                           action="store_true",
                           help=( "Uses a previously trained model to compare its predictions \n"
                                  "against its testing data set."
                                )
                         )

    arggroup.add_argument( "--compare-train",
                           action="store_true",
                           help=( "Uses a previously trained model to compare its predictions \n"
    ...
    parser.add_argument( "-csv",
                         "--csv-file-name",
                         default=None,
                         help=( "Name of a tab delimited local CSV file containing a data set for model training. \n"
    ...
    parser.add_argument( "--min-token-frequency",
                         type=int,
                         default=30,
                         help=( "The minimum number of times a token should occur in the dataset \n"
    ...
    parser.add_argument( "-min-tokens",
                         ...
                         type=int,
                         default=4,
                         help=( "The minimum number of tokens a sample should contain to be used \n"
    ...
    parser.add_argument( "-max-tokens",
                         ...
                         type=int,
                         default=10,
                         help=( "The maximum number of tokens a sample should contain for training \n"
